...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combokeys = __webpack_require__(1);
	
	var _combokeys2 = _interopRequireDefault(_combokeys);
	
	var _d3Git = __webpack_require__(34);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
	
	var list = [].concat(_toConsumableArray(document.getElementsByClassName('git-graph')));
	...
	function getCurrentGraph() {
	  ...
	  var graphId = slide.querySelector('.git-graph').id;
	  return (0, _d3Git.getD3GitGraphByContainerId)(graphId);
	}
	
	list.forEach(function (graph) {
	  var jsonURL = graph.getAttribute('data-src');
	
	  if (jsonURL) {
	    var height = graph.getAttribute('data-height');
	    var width = graph.getAttribute('data-width');
	    var viewBox = graph.getAttribute('data-viewBox');
	
	    (0, _d3Git.initializeD3GitGraph)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.prototype.bind = __webpack_require__(2)
	module.exports.prototype.bindMultiple = __webpack_require__(3)
	module.exports.prototype.unbind = __webpack_require__(4)
	module.exports.prototype.trigger = __webpack_require__(5)
	module.exports.prototype.reset = __webpack_require__(6)
	module.exports.prototype.stopCallback = __webpack_require__(7)
	module.exports.prototype.handleKey = __webpack_require__(8)
	module.exports.prototype.addEvents = __webpack_require__(10)
	module.exports.prototype.bindSingle = __webpack_require__(17)
	module.exports.prototype.getKeyInfo = __webpack_require__(18)
	module.exports.prototype.pickBestAction = __webpack_require__(22)
	module.exports.prototype.getReverseMap = __webpack_require__(23)
	module.exports.prototype.getMatches = __webpack_require__(24)
	module.exports.prototype.resetSequences = __webpack_require__(26)
	module.exports.prototype.fireCallback = __webpack_require__(27)
	module.exports.prototype.bindSequence = __webpack_require__(30)
	module.exports.prototype.resetSequenceTimer = __webpack_require__(31)
	module.exports.prototype.detach = __webpack_require__(32)
	
	module.exports.instances = []
	module.exports.reset = __webpack_require__(33)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (character, modifiers, e) {
	  ...
	  isModifier = __webpack_require__(9)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  var self = this
	  var on = __webpack_require__(11)
	  var element = self.element
	
	  self.eventHandler = __webpack_require__(12).bind(self)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (e) {
	  ...
	  characterFromEvent = __webpack_require__(13)
	  ...
	  eventModifiers = __webpack_require__(16)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (e) {
	  ...
	  SPECIAL_KEYS_MAP = __webpack_require__(14)
	  SPECIAL_CHARACTERS_MAP = __webpack_require__(15)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (combination, action) {
	  ...
	  keysFromString = __webpack_require__(19)
	  // take the keys from this pattern and figure out what the actual
	  // pattern is all about
	  keys = keysFromString(combination)
	
	  SPECIAL_ALIASES = __webpack_require__(20)
	  SHIFT_MAP = __webpack_require__(21)
	  isModifier = __webpack_require__(9)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (character, modifiers, e, sequenceName, combination, level) {
	  ...
	  for (j = 0; j < self.callbacks[character].length; ++j) {
	    ...
	    modifiersMatch = __webpack_require__(25)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (callback, e, combo, sequence) {
	  ...
	  if (callback(e, combo) === false) {
	    preventDefault = __webpack_require__(28)
	    preventDefault(e)
	    stopPropagation = __webpack_require__(29)
	    stopPropagation(e)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var off = __webpack_require__(11).off
	module.exports = function () {
	  var self = this
	  var element = self.element
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.initializeD3GitGraph = initializeD3GitGraph;
	exports.getD3GitGraphByContainerId = getD3GitGraphByContainerId;
	
	var _d = __webpack_require__(35);
	
	var _d2 = _interopRequireDefault(_d);
	
	var _gitGraph = __webpack_require__(36);
	...
	function initializeD3GitGraph(_ref) {
	  var _ref$containerId = _ref.containerId;
	  var containerId = _ref$containerId === undefined ? mandatory('containerId is missing') : _ref$containerId;
	  var _ref$jsonURL = _ref.jsonURL;
	  var jsonURL = _ref$jsonURL === undefined ? mandatory('JSON URL is missing') : _ref$jsonURL;
	  var _ref$width = _ref.width;
	  var width = _ref$width === undefined ? 1024 : _ref$width;
	  ...
	  _d2.default.json(jsonURL, function (error, data) {
	    ...
	    var graph = new _gitGraph2.default({
	      containerId: containerId, width: width, height: height, viewBox: viewBox,
	      legend: legend, comments: comments, branches: branches, steps: steps, headless: headless
	    });
	...
	function getD3GitGraphByContainerId(id) {
	  return graphs[id];
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d2 = __webpack_require__(35);
	
	var _d3 = _interopRequireDefault(_d2);
	
	var _gitBranch = __webpack_require__(37);
	
	var _gitBranch2 = _interopRequireDefault(_gitBranch);
	
	var _gitBlock = __webpack_require__(38);
	...
	var GitGraph = exports.GitGraph = function () {
	  function GitGraph(_ref) // SVG container dimensions
	  {
	    var _this = this;
	    ...
	    var steps = _ref$steps === undefined ? [] : _ref$steps;
	    var _ref$headless = _ref.headless;
	    var headless = _ref$headless === undefined ? false : _ref$headless;
	    var _ref$width = _ref.width;
	    var width = _ref$width === undefined ? 1024 : _ref$width;
	    var _ref$height = _ref.height;
	    var height = _ref$height === undefined ? 500 : _ref$height;
	    var _ref$viewBox = _ref.viewBox;
	    var viewBox = _ref$viewBox === undefined ? null : _ref$viewBox;
	
	    _classCallCheck(this, GitGraph);
	    ...
	    this.y = legend ? comments ? 2 * TEXT_HEIGHT + PADDING : this.blockHeight + this.yGap : 0;
	
	    this.setupContainer({ containerId: containerId, width: width, height: height, viewBox: viewBox });
	
	    // Register branches
	    this.branches = [];
	    branches.forEach(function (branch) {
	      return _this.addBranch(branch);
	    });
	
	    this.initialState = { branches: branches, legend: legend, comments: comments };
	  }
	  ...
	  _createClass(GitGraph, [{
	    ...
	    value: function addBranch(branch) {
	      ...
	      var br = new _gitBranch2.default({
	        graph: this,
	        origin: origin,
	    ...
	    key: 'animateText',
	    value: function animateText(_ref2) {
	      var _this2 = this;
	
	      var d3Text = _ref2.d3Text;
	      var text = _ref2.text;
	      var yStart = _ref2.yStart;
	      var _ref2$animation = _ref2.animation;
	      var animation = _ref2$animation === undefined ? 'easeIn' : _ref2$animation;
	      var _ref2$duration = _ref2.duration;
	      var duration = _ref2$duration === undefined ? 500 : _ref2$duration;
	      var callback = _ref2.callback;
	
	      if (animation === 'easeOut') {
	        d3Text.transition().duration(duration).attr('y', yStart - 2 * this.blockHeight).style('opacity', 0).each('end', function () {
	          _this2.animateText({ d3Text: d3Text, text: text, yStart: yStart, animation: 'easeIn', duration: duration, callback: callback });
	        });
	      } else if (animation === 'easeIn') {
	        d3Text.text(text).attr('y', yStart + 2 * this.blockHeight).transition().duration(duration).style('opacity', 1).attr('y', yStart + this.blockHeight / 2).each('end', function () {
	          callback && setTimeout(callback, duration);
	        });
	      } else if (animation === 'fadeOut') {
	        d3Text.transition().duration(duration).style('opacity', 0).each('end', function () {
	          _this2.animateText({ d3Text: d3Text, text: text, yStart: yStart, animation: 'fadeIn', duration: duration, callback: callback });
	        });
	      } else if (animation === 'fadeIn') {
	        d3Text.text(text).transition().duration(duration).style('opacity', 1).each('end', function () {
	          callback && setTimeout(callback, duration);
	        });
	      }
	    }
	    ...
	    value: function draw() {
	      ...
	      this.drawLegend({ callback: function callback() {
	          _this3.branches.forEach(function (branch) {
	            return branch.draw();
	          });
	        } });
	    }
	    ...
	    key: 'drawComments',
	    value: function drawComments(_ref3) {
	      var callback = _ref3.callback;
	      var _ref3$animations = _ref3.animations;
	      var animations = _ref3$animations === undefined ? {} : _ref3$animations;
	      ...
	      this.drawText({
	        ...
	        yPos: TEXT_HEIGHT,
	        callback: callback,
	        animations: _extends({}, animations, { yStart: this.legend ? TEXT_HEIGHT : 0 })
	      });
	    }
	    ...
	    key: 'drawLegend',
	    value: function drawLegend(_ref4) {
	      var callback = _ref4.callback;
	      var _ref4$animations = _ref4.animations;
	      var animations = _ref4$animations === undefined ? { in: 'easeIn', out: 'easeOut' } : _ref4$animations;
	      ...
	      this.drawText({
	        ...
	        yPos: TEXT_HEIGHT / 2,
	        callback: callback,
	        animations: _extends({}, animations, { yStart: 0 })
	      });
	    ...
	    key: 'drawText',
	    value: function drawText(_ref5) {
	      var text = _ref5.text;
	      var selector = _ref5.selector;
	      var _ref5$xPos = _ref5.xPos;
	      var xPos = _ref5$xPos === undefined ? 0 : _ref5$xPos;
	      var yPos = _ref5.yPos;
	      var _ref5$callback = _ref5.callback;
	      var callback = _ref5$callback === undefined ? function () {} : _ref5$callback;
	      var animations = _ref5.animations;
	
	      if (!text) {
	        return callback();
	      }
	
	      var d3Text = this.container.select('#' + selector);
	
	      if (!d3Text.empty()) {
	        if (animations) {
	          this.animateText({ d3Text: d3Text, text: text, yStart: animations.yStart, animation: animations.out, callback: callback });
	        } else {
	          d3Text.text(text);
	          callback();
	        }
	      } else {
	        d3Text = this.container.append('text').text(text).attr('id', selector).attr('class', selector).attr('x', xPos).attr('y', yPos);
	
	        if (animations) {
	          this.animateText({ d3Text: d3Text, text: text, yStart: animations.yStart, animation: animations.in, callback: callback });
	          callback();
	        }
	      }
	    }
	    ...
	    key: 'findBranch',
	    value: function findBranch(label) {
	      var br = this.branches.find(function (branch) {
	    ...
	    value: function nextStep() {
	      ...
	      var step = this.steps[this.lastStepIndex];
	      if (!step) {
	        return;
	      }
	      ...
	      if (step.legend) {
	        ...
	        this.drawLegend({ callback: function callback() {
	            return _this4.processActions(step.actions);
	          } });
	      } else {
	    ...
	    value: function reset() {
	      ...
	      this.branches = [];
	      this.initialState.branches.forEach(function (branch) {
	        return _this5.addBranch(branch);
	      });
	    ...
	    value: function processActions(actions) {
	      ...
	      actions.forEach(function (action) {
	        ...
	        if (typeof _this6[method] !== 'function') {
	          throw new Error('Unknown method ' + method + ' for ' + _this6.constructor.name);
	        }
	        _this6[method](action);
	      });
	    }
	    ...
	    key: 'addClassToCommit',
	    value: function addClassToCommit(_ref6) {
	      var branch = _ref6.branch;
	      var commit = _ref6.commit;
	      var className = _ref6.className;
	
	      var br = this.findBranch(branch);
	      var co = br.findCommit(commit);
	    ...
	    key: 'addCommits',
	    value: function addCommits(_ref7) {
	      var branch = _ref7.branch;
	      var commits = _ref7.commits;
	
	      var br = this.findBranch(branch);
	      commits.forEach(function (commitLabel) {
	        return br.addCommit(commitLabel).draw();
	      });
	    }
	    ...
	    key: 'attachCommits',
	    value: function attachCommits(_ref8) {
	      var branch = _ref8.branch;
	      var _ref8$commits = _ref8.commits;
	      var commits = _ref8$commits === undefined ? [] : _ref8$commits;
	
	      var source = this.findBranch(branch);
	      commits.forEach(function (label) {
	        var commit = source.findCommit(label);
	        if (commit) {
	          commit.attach();
	        }
	      });
	    ...
	    key: 'detachCommits',
	    value: function detachCommits(_ref9) {
	      var branch = _ref9.branch;
	      var _ref9$commits = _ref9.commits;
	      var commits = _ref9$commits === undefined ? [] : _ref9$commits;
	    ...
	    value: function merge(_ref10) {
	      ...
	      var _map = [source, target].map(function (_ref11) {
	        var branch = _ref11.branch;
	        var commit = _ref11.commit;
	        return _this7.findBranch(branch).findCommit(commit);
	      });
	      ...
	      var commit = new _gitBlock.MergeCommit({ label: label, source: source, target: target });
	    ...
	    key: 'moveBranch',
	    value: function moveBranch(_ref12) {
	      var branch = _ref12.branch;
	    ...
	    key: 'moveBranchTag',
	    value: function moveBranchTag(_ref13) {
	      var branch = _ref13.branch;
	      var target = _ref13.target;
	      var targetBranch = _ref13.targetBranch;
	      var _ref13$tagPosition = _ref13.tagPosition;
	      var tagPosition = _ref13$tagPosition === undefined ? null : _ref13$tagPosition;
	
	      var source = this.findBranch(branch);
	      var origin = targetBranch ? this.findBranch(targetBranch).findCommit(target) : source.findCommit(target);
	    ...
	    key: 'moveHeadTag',
	    value: function moveHeadTag(_ref14) {
	      var branch = _ref14.branch;
	      var _ref14$target = _ref14.target;
	      var target = _ref14$target === undefined ? null : _ref14$target;
	      var _ref14$tagPosition = _ref14.tagPosition;
	      var tagPosition = _ref14$tagPosition === undefined ? null : _ref14$tagPosition;
	      ...
	      var origin = target ? source.findCommit(target) : source.branchTag;
	    ...
	    key: 'removeBranchTag',
	    value: function removeBranchTag(_ref15) {
	      var branch = _ref15.branch;
	    ...
	    key: 'removeCommits',
	    value: function removeCommits(_ref16) {
	      var branch = _ref16.branch;
	      var _ref16$commits = _ref16.commits;
	      var commits = _ref16$commits === undefined ? [] : _ref16$commits;
	    ...
	    key: 'renameBranchTag',
	    value: function renameBranchTag(_ref17) {
	      var branch = _ref17.branch;
	    ...
	    key: 'setBranch',
	    value: function setBranch(_ref18) {
	    ...
	    key: 'setupContainer',
	    value: function setupContainer(_ref19) {
	      var _this8 = this;
	
	      var containerId = _ref19.containerId;
	      var width = _ref19.width;
	      var height = _ref19.height;
	      var viewBox = _ref19.viewBox;
	
	      var mainContainer = _d3.default.select('#' + containerId).append('svg').attr('xmlns', 'http://www.w3.org/2000/svg').attr('version', '1.1').attr('viewBox', viewBox || '0 0 ' + width * 1.2 + ' ' + height * 1.2).attr('preserveAspectRatio', 'xMidYMid meet').attr('width', Math.min(width + 2 * PADDING, MIN_WIDTH)).attr('height', height + 2 * PADDING).attr('id', this.id);
	
	      this.container = mainContainer.append('g').attr('transform', 'translate(' + PADDING + ',' + PADDING + ')');
	
	      if (this.steps.length) {
	        // Manage steps control when clicking on SVG
	        mainContainer.on('click', function () {
	          return _this8.nextStep();
	        });
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Branch = exports.Branch = function () {
	  function Branch(_ref) {
	    ...
	    var detachedCommits = _ref.detachedCommits;
	    var branchTag = _ref.branchTag;
	    var headTag = _ref.headTag;
	    var startAt = _ref.startAt;
	    var _ref$tagPosition = _ref.tagPosition;
	    var tagPosition = _ref$tagPosition === undefined ? 'bottom' : _ref$tagPosition;
	  ...
	  _createClass(Branch, [{
	    key: 'addCommit',
	    value: function addCommit(label) {
	      var id = this.id + '-' + this.commits.length;
	      var origin = this.commits.last() || this.startCommit;
	      var commit = new _gitBlock.Commit({ id: id, label: label, origin: origin, branch: this });
	    ...
	    key: 'findCommit',
	    value: function findCommit(label) {
	      var commit = this.commits.find(function (commit) {
	    ...
	    value: function move(target) {
	      var origin = this.graph.findBranch(target.branch);
	      if (!origin) {
	        throw new Error('Cannot find targeted branch <' + target.branch + '>');
	      }
	      var startCommit = origin.findCommit(target.commit);
	      if (!startCommit) {
	      ...
	      this.commits.reduce(function (lastCommit, commit) {
	        return commit.refresh(lastCommit).move();
	      }, startCommit);
	    ...
	    key: 'removeCommits',
	    value: function removeCommits(commits) {
	      var _this2 = this;
	
	      var commitLabels = this.commits.map(function (_ref2) {
	        var label = _ref2.label;
	        return label;
	      });
	      commits.forEach(function (commitLabel) {
	        var commit = _this2.findCommit(commitLabel);
	        if (commit) {
	          var index = commitLabels.indexOf(commitLabel);
	          // Remove block from graph
	          commit.remove();
	          // Finaly remove commit from branch
	          _this2.commits = _this2.commits.filter(function (currCommit) {
	            return currCommit.label !== commitLabel;
	          });
	          _this2.commits.last = function last() {
	            return this[this.length - 1];
	          };
	          // Then update branch blocks positions
	          if (_this2.commits.length > index) {
	            var startCommit = _this2.commits[index];
	            _this2.commits.slice(index).reduce(function (lastCommit, commit) {
	              return commit.refresh(lastCommit).move();
	            }, startCommit);
	          }
	        }
	    ...
	    key: 'setBranchTag',
	    value: function setBranchTag(branchTag) {
	      var commit = void 0;
	      if (!branchTag) {
	      ...
	      if (commit) {
	        this.branchTag = new _gitBlock.BranchTag({ branch: this, origin: commit, position: this.tagPosition });
	      }
	    }
	    ...
	    key: 'setHeadTag',
	    value: function setHeadTag(headTag) {
	      if (!headTag) {
	        return;
	      }
	
	      var branchTag = this.branchTag || this.findCommit(headTag);
	      if (branchTag) {
	        this.headTag = new _gitBlock.HeadTag({ branch: this, origin: branchTag, position: this.tagPosition });
	      }
	    }
	    ...
	    key: 'setOrigin',
	    value: function setOrigin(origin, startAt) {
	      var withCommits = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
	      ...
	      if (!withCommits) {
	        ...
	        var gap = this.graph.blockHeight + this.graph.yGap;
	    ...
	    key: 'xNext',
	    value: function xNext() {
	      var startCommit = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	
	      if (this.commits.length === 0) {
	        return this.x;
	      }
	
	      var lastCommit = startCommit || this.commits.last();
	    ...
	    key: 'yNext',
	    value: function yNext() {
	      var xAxis = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	
	      var gap = this.graph.blockHeight + this.graph.yGap;
	      var sameAxis = xAxis ? xAxis === this.branchTag.x : true;
	    ...
	    key: 'yPrevious',
	    value: function yPrevious() {
	      var source = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	
	      var gap = this.graph.blockHeight + this.graph.yGap;
	      var sameAxis = source ? source.x === this.branchTag.x && source.position === this.branchTag.position : true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BranchTag = exports.HeadTag = exports.MergeCommit = exports.Commit = exports.Block = undefined;
	...
	var diagonal = _d2.default.svg.diagonal().source(function (_ref) {
	  var _ref$source = _ref.source;
	  var x = _ref$source.x;
	  var y = _ref$source.y;
	  return { x: y, y: x };
	}).target(function (_ref2) {
	  var _ref2$target = _ref2.target;
	  var x = _ref2$target.x;
	  var y = _ref2$target.y;
	  return { x: y, y: x };
	}).projection(function (_ref3) {
	  var y = _ref3.y;
	  var x = _ref3.x;
	  return [y, x];
	});
	...
	var Block = exports.Block = function () {
	  function Block(_ref4) {
	    ...
	    var position = _ref4$position === undefined ? 'right' : _ref4$position;
	    ...
	    this.branch = branch;
	    this.origins = origins.filter(function (value) {
	      return value;
	    });
	  ...
	  _createClass(Block, [{
	    ...
	    value: function draw() {
	      ...
	      var selector = this.remove();
	
	      this.block = this.container.selectAll('#' + selector).data([this]).enter().append('g').attr('id', selector).attr('class', this.classes.join(' ')).attr('transform', 'translate(' + this.x + ',' + this.y + ')');
	
	      // Set shape/rectangle
	      this.block.append('rect').attr({
	        height: this.height,
	        width: this.width,
	        ry: CORNER_RADIUS,
	        rx: CORNER_RADIUS
	      ...
	      // Add text
	      this.block.append('text').text(this.label).attr('x', this.width / 2)
	      ...
	      // Animate
	      this.block.style('opacity', 0).transition().duration(1000).style('opacity', 1).each('end', callback);
	    ...
	    value: function drawLinks() {
	      ...
	      var selector = 'diagonal-' + this.id.replace(/(\/|\\)/, '-');
	      ...
	      var lnks = (this.origins || []).map(function (origin) {
	        // Manage positions
	        var xSource = _this.width / 2;
	        var ySource = _this.height / 2;
	
	        if (_this.position === 'right') {
	          xSource = _this.width;
	        } else if (_this.position === 'left') {
	          xSource = 0;
	        }
	
	        if (_this.position === 'bottom') {
	          ySource = _this.height;
	        } else if (_this.position === 'top') {
	          ySource = 0;
	        }
	
	        var xTarget = ['top', 'bottom'].includes(_this.position) ? _this.width / 2 : 0;
	        var yTarget = _this.height / 2;
	        if (_this.position === 'bottom') {
	          yTarget = 0;
	        } else if (_this.position === 'top') {
	          yTarget = _this.height;
	        }
	
	        return {
	          source: {
	            x: origin.x + xSource - _this.x,
	            y: origin.y + ySource - _this.y
	          },
	          target: {
	            x: xTarget,
	            y: yTarget
	      ...
	      this.links = (this.block || this.container).selectAll('.' + selector).data(lnks).enter().append('path').attr('class', 'link link-' + this.kind + ' ' + selector).attr('d', diagonal);
	      // Animate
	      this.links.style('opacity', 0).transition().duration(1000).style('opacity', 1);
	    }
	    ...
	    value: function detach() {
	      this.classes = [].concat(_toConsumableArray(this.classes), ['detached']);
	      if (this.block) {
	        this.block.attr('class', this.classes.join(' '));
	      }
	    }
	    ...
	    key: 'move',
	    value: function move() {
	      this.block.transition().duration(1000).attr('transform', 'translate(' + this.x + ',' + this.y + ')');
	      this.drawLinks();
	      return this;
	    }
	    ...
	    key: 'refresh',
	    value: function refresh(startCommit) {
	    ...
	    value: function remove() {
	      var selector = 'block-' + this.id.replace(/[/\\]/g, '-');
	...
	var Commit = exports.Commit = function (_Block) {
	  _inherits(Commit, _Block);
	
	  function Commit(_ref5) {
	    var label = _ref5.label;
	    var branch = _ref5.branch;
	    var origin = _ref5.origin;
	    var _ref5$id = _ref5.id;
	    var id = _ref5$id === undefined ? label : _ref5$id;
	    var _ref5$position = _ref5.position;
	    var position = _ref5$position === undefined ? 'right' : _ref5$position;
	
	    _classCallCheck(this, Commit);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Commit).call(this, _extends({}, arguments[0], {
	      kind: 'commit',
	      origins: [origin]
	    })));
	  }
	...
	var MergeCommit = exports.MergeCommit = function (_Block2) {
	  _inherits(MergeCommit, _Block2);
	
	  function MergeCommit(_ref6) {
	    var label = _ref6.label;
	    var source = _ref6.source;
	    var target = _ref6.target;
	
	    _classCallCheck(this, MergeCommit);
	
	    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(MergeCommit).call(this, {
	    ...
	    _this3.x = source.x > target.x ? source.branch.xNext() : target.branch.xNext();
	    return _this3;
	  }
	...
	var HeadTag = exports.HeadTag = function (_Block3) {
	  _inherits(HeadTag, _Block3);
	
	  function HeadTag(_ref7) {
	    var branch = _ref7.branch;
	    var origin = _ref7.origin;
	    var _ref7$position = _ref7.position;
	    var position = _ref7$position === undefined ? 'bottom' : _ref7$position;
	
	    _classCallCheck(this, HeadTag);
	
	    var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(HeadTag).call(this, {
	      branch: branch,
	      kind: 'head',
	      label: 'HEAD',
	      id: 'head-' + branch.id,
	    ...
	    _this4.x = origin.x;
	    _this4.y = position === 'top' ? branch.yPrevious() : branch.yNext();
	    return _this4;
	  }
	  ...
	  _createClass(HeadTag, [{
	    key: 'refresh',
	    value: function refresh(origin, tagPosition) {
	      _get(Object.getPrototypeOf(HeadTag.prototype), 'refresh', this).call(this, origin);
	...
	var BranchTag = exports.BranchTag = function (_Block4) {
	  _inherits(BranchTag, _Block4);
	
	  function BranchTag(_ref8) {
	    var branch = _ref8.branch;
	    var origin = _ref8.origin;
	    var _ref8$position = _ref8.position;
	    var position = _ref8$position === undefined ? 'bottom' : _ref8$position;
	
	    _classCallCheck(this, BranchTag);
	
	    var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(BranchTag).call(this, {
	      branch: branch,
	      kind: 'branch',
	      origins: [origin],
	      id: 'branch-' + branch.id,
	    ...
	    _this5.x = origin.x;
	    _this5.y = position === 'top' ? branch.yPrevious() : branch.yNext();
	    return _this5;
	  }
	  ...
	  _createClass(BranchTag, [{
	    key: 'refresh',
	    value: function refresh(origin, tagPosition) {
	      _get(Object.getPrototypeOf(BranchTag.prototype), 'refresh', this).call(this, origin);
	      if (origin && !tagPosition) {
	        this.position = this.branch.tagPosition = origin.branch.tagPosition;
	      } else if (tagPosition) {
	        this.position = tagPosition;
...
/***/ }
/******/ ]);
//# sourceMappingURL=git-total-graphs.bundle.js.map